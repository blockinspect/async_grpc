...
execute_process(
  ...
  WORKING_DIRECTORY "GIT_COMMIT_HASH="e3bd4cbeaeef3cee65a68a8bd3c535cb779e9b6d""
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'GIT_COMMIT_HASH="e3bd4cbeaeef3cee65a68a8bd3c535cb779e9b6d"/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'GIT_COMMIT_HASH="e3bd4cbeaeef3cee65a68a8bd3c535cb779e9b6d"/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to update submodules in: 'GIT_COMMIT_HASH="e3bd4cbeaeef3cee65a68a8bd3c535cb779e9b6d"/'")
  endif()
endif()
